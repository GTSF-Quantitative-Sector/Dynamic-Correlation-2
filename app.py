...
def correlationMatrix():
    print(request.json)
    tckrs, corrs, _unused = correlation(request.json["tckrs"], request.json["start"], request.json["end"],
                                        request.json["step"])
...
def get_treynor():
    tckrs, corrs_df, _unused = correlation(request.json["tckrs"], request.json["start"], request.json["end"],
                                           request.json["step"])
